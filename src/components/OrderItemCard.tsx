...
interface OrderItemCardProps {
    ...
    special_ingerdient: string
    prices: any
    ItemPrice: string
}

const OrderItemCard: React.FC<OrderItemCardProps> = ({ type, name, imagelink_square, special_ingerdient, prices, ItemPrice }) => {
    return (
        <LinearGradient
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 1 }}
            ...
            <View style={styles.CardInfoContainer}>
                <View style={styles.CardImageInfoContainer}>
                    ...
                    <View>
                        ...
                        <Text style={styles.CardSubtitle}>{special_ingerdient}</Text>
                    </View>
                </View>
                <View>
